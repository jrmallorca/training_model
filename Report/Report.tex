...
\section{Results}
	...
	\noindent
	In the last data segment of Figure \ref{fig:adv_3}, the program chose to use a linear function type to fit the data as it had the lowest CVE when $p = 4$. It is clear that using $p = 4$ or higher would lead to overfitting.
	%
	\begin{figure}[ht]
